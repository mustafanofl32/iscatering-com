...
.scene__shade{position:absolute;inset:0;pointer-events:none;
  background:
    linear-gradient(90deg,rgba(11,23,18,.60) 0%,rgba(11,23,18,.42) 30%,rgba(11,23,18,.14) 52%,transparent 66%),
    radial-gradient(100% 85% at 0% 100%,rgba(11,23,18,.74) 0%,rgba(11,23,18,.42) 42%,transparent 74%),
    linear-gradient(180deg,rgba(11,23,18,.55) 0%,transparent 22%)}
...
.scene__copy .kicker{font-family:"IBM Plex Mono",ui-monospace,SFMono-Regular,monospace;font-size:11.5px;font-weight:400;
  text-transform:uppercase;letter-spacing:.18em;line-height:1.4;margin:0 0 14px;color:#CFE3D4}
...
.scene__copy .btn--accent{background:#CFE3D4;color:#12241C}
...
@media (max-width:820px){
  ...
  .scene__shade{display:block;background:linear-gradient(180deg,rgba(11,23,18,.74) 0%,rgba(11,23,18,.18) 24%,transparent 44%)}
